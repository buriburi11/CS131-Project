...
function draw()
{
    ...
    else if(currentState == state.MATCHLEVEL)
    {
        ...
        speak("choose a level to start the game! click or use the arrow keys to move. press the space bar or enter to flip the cards. To choose a level: click, or press 1 for level one, 2 for level two, and 3 for level three.");
